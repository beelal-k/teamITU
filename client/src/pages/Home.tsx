        ...
        <div className="w-full py-10 px-5 flex flex-col gap-8">
          <div className="w-full flex flex-row justify-between gap-5 border bg-white rounded-lg p-5 shadow-xl">
            ...
            <div className="w-1/3 flex flex-col justify-between">
              ...
              <Button className="bg-primary text-white dark:text-white dark:hover:bg-[#e2a43f]/90 dark:bg-primary hover:bg-[#e2a43f] mb-6">View Deposits</Button>
            </div>
          </div>
          <div className="w-full flex flex-row bg-white justify-between gap-5 border rounded-lg p-5 shadow-xl">
            ...
            <div className="w-1/3 flex flex-col justify-between">
              ...
              <Button className="bg-primary text-white dark:text-white dark:hover:bg-[#e2a43f] dark:bg-primary hover:bg-[#e2a43f] mb-6">View Withdrawals</Button>
            </div>
          </div>
        </div>
